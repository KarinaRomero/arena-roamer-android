    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPlayer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(),AndroidStarter.class);
                i.putExtra("player","1");
                startActivity(i);
    ...
    public void onStart() {
       ...
       /* client.connect();
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.theinvader360.arenaroamer/http/host/path")
        );
